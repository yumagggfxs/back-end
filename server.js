...
/* ============================================================
   24.x — MESSAGERIE UTILISATEUR RAPIDE
   ============================================================ */
...
app.get(
    ...
    async (req, res) => {
        ...
        try {
             ...
             * - détermine l'audience
             * - récupère les messages personnels
             * - récupère les annonces officielles
             */
            ...
            const result =
                await pool.query(
                    ...
                    INNER JOIN current_user u
                        ON TRUE

                    WHERE

                        m.recipient_user_id = u.id
